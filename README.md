...
### 🏥 [Rede de Farmácias — Estoque (DrugStoreDB)](./estoque_farmaceutico)
...
📄 Detalhes completos no [README do projeto](./estoque_farmaceutico/README.md).
...
### 🏥 [Pharmacy Chain — Stock (DrugStoreDB)](./estoque_farmaceutico)
...
📄 Full details in the [project README](./estoque_farmaceutico/README.md).
